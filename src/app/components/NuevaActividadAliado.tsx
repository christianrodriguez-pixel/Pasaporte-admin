import { Home, ChevronRight, Save, X, ChevronLeft, MapPin, Building2, Phone, Mail, Tag, Plus, Trash2, Calendar } from 'lucide-react';
...
interface NuevaActividadAliadoProps {
  onInicio?: () => void;
  onVolver: () => void;
  aliado: any;
}
...
export function NuevaActividadAliado({ onInicio, onVolver, aliado }: NuevaActividadAliadoProps) {
  ...
  const categoriasExplora = getCategoriasActivasPorSeccion('explora');
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      ...
      <div className="flex items-center gap-2 text-xs md:text-sm mb-4 md:mb-6">
        ...
        <ChevronRight className="w-4 h-4 text-gray-400" />
        <span className="text-gray-900 font-semibold">Nueva Actividad</span>
      </div>

      {/* Título y descripción */}
      <div className="mb-4 md:mb-6">
        <h1 className="text-[#922735] text-xl md:text-2xl font-bold mb-2">Registrar Nueva Actividad</h1>
        <p className="text-gray-600 text-xs md:text-sm">
          Registra una nueva actividad, promoción o beneficio para el aliado seleccionado
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        {/* Formulario */}
        <form className="p-6">
          {/* Tab: Información de la Actividad */}
          {tabActivo === 'informacion' && (
            <div className="space-y-4">
              <div>
                <h2 className="text-gray-900 font-semibold text-base mb-2">Información de la Actividad</h2>
                <p className="text-gray-600 text-xs mb-4">
                  Proporciona los datos generales de la actividad o beneficio
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="Ej: Taller de fotografía digital, Conferencia de emprendimiento"
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    Nombre corto y descriptivo de la actividad
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {categoriasExplora.map((categoria) => (
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    placeholder="Describe los detalles de la actividad, cómo funciona, requisitos, etc..."
                  ...
                  />
                  <p className="text-gray-500 text-xs mt-1">
                    Información completa sobre la actividad
                  </p>
                </div>
              </div>
            </div>
          ...
          {tabActivo === 'ubicacion' && (
            <div className="space-y-4">
              <div>
                <h2 className="text-gray-900 font-semibold text-base mb-2">Ubicación de la Actividad</h2>
                <p className="text-gray-600 text-xs mb-4">
                  Define dónde se llevará a cabo esta actividad
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mt-1">
                      Ubicación de la actividad en Tamaulipas
                    </p>
                  </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-gray-500 text-xs mt-1">
                    Dirección completa donde se realizará la actividad
                  </p>
                </div>
                ...
                <div className="border-t border-gray-200 pt-4 mt-4">
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-semibold mb-2">
                      Radio de cobertura para check-in *
                    </label>
                    <div className="relative">
                      <input
                        ...
                        max="5000"
                        defaultValue="100"
                        className="w-full px-4 py-2.5 pr-16 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#922735] focus:border-transparent"
                        required
                      />
                    ...
                    <p className="text-gray-500 text-xs mt-1">
                      Distancia desde el punto central (10-5000 metros)
                    </p>
                    <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                      <p className="text-blue-800 text-xs">
                        <strong>ℹ️ Validación de check-in:</strong> Los jóvenes solo podrán hacer check-in en la app móvil cuando se encuentren dentro del radio configurado desde el punto central de la actividad. Esto garantiza que estén físicamente presentes en el evento.
                      </p>
                    </div>
                  </div>
          ...
          {tabActivo === 'vigencia' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 text-xs mb-4">
                  Define cuándo y en qué horarios estará disponible la actividad
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <label className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-gray-700 text-sm font-semibold">Actividad permanente (sin fecha de término)</span>
                </label>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  ...
                  <p className="text-gray-500 text-xs mt-1 ml-6">
                    La actividad estará disponible las 24 horas en los días seleccionados
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    Veces que un usuario puede usar esta actividad
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-gray-500 text-xs mt-1">
                    Puntos que el usuario recibirá al completar esta actividad (0 = no otorga)
                  </p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  <p className="text-gray-500 text-xs mt-1">
                    Opcional - Condiciones especiales de la actividad
                  </p>
                </div>
              </div>
            </div>
          ...
          {tabActivo === 'movil' && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 text-xs mb-4">
                  Define cómo se mostrará esta actividad en la aplicación móvil del Pasaporte Joven Tamaulipas
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-500 text-xs mt-1 ml-6">
                    Los jóvenes deberán inscribirse antes de participar
                  </p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-500 text-xs mt-1 ml-6">
                    La actividad tiene algún costo o pago para participar
                  </p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  <p className="text-gray-500 text-xs mt-1">
                    Número de contacto para información de la actividad
                  </p>
                </div>
          ...
          <div className="flex items-center justify-between pt-6 mt-6 border-t border-gray-200">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Botón Siguiente o Guardar actividad */}
              {!esUltimoTab ? (
                <button
                  type="button"
